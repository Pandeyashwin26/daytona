...
type OrganizationsAPI interface {
	...
	*/
	...
	/*
		GetOrganizationBySandboxAuthToken Get organization by sandbox auth token

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param authToken Sandbox Auth Token
		@return OrganizationsAPIGetOrganizationBySandboxAuthTokenRequest
	*/
	GetOrganizationBySandboxAuthToken(ctx context.Context, authToken string) OrganizationsAPIGetOrganizationBySandboxAuthTokenRequest

	// GetOrganizationBySandboxAuthTokenExecute executes the request
	//  @return Organization
	GetOrganizationBySandboxAuthTokenExecute(r OrganizationsAPIGetOrganizationBySandboxAuthTokenRequest) (*Organization, *http.Response, error)
...
type OrganizationsAPIGetOrganizationBySandboxAuthTokenRequest struct {
	ctx        context.Context
	ApiService OrganizationsAPI
	authToken  string
}

func (r OrganizationsAPIGetOrganizationBySandboxAuthTokenRequest) Execute() (*Organization, *http.Response, error) {
	return r.ApiService.GetOrganizationBySandboxAuthTokenExecute(r)
}
...
GetOrganizationBySandboxAuthToken Get organization by sandbox auth token
	...
	@return OrganizationsAPIGetOrganizationBySandboxAuthTokenRequest
*/
func (a *OrganizationsAPIService) GetOrganizationBySandboxAuthToken(ctx context.Context, authToken string) OrganizationsAPIGetOrganizationBySandboxAuthTokenRequest {
	return OrganizationsAPIGetOrganizationBySandboxAuthTokenRequest{
		ApiService: a,
		ctx:        ctx,
		authToken:  authToken,
...
//
//	@return Organization
func (a *OrganizationsAPIService) GetOrganizationBySandboxAuthTokenExecute(r OrganizationsAPIGetOrganizationBySandboxAuthTokenRequest) (*Organization, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsAPIService.GetOrganizationBySandboxAuthToken")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organizations/by-sandbox-auth-token/{authToken}"
