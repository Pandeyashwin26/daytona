...
export const OrganizationsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    getOrganizationBySandboxAuthToken: async (
      authToken: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'authToken' is not null or undefined
      assertParamExists('getOrganizationBySandboxAuthToken', 'authToken', authToken)
      const localVarPath = `/organizations/by-sandbox-auth-token/{authToken}`.replace(
        `{${'authToken'}}`,
...
export const OrganizationsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getOrganizationBySandboxAuthToken(
      authToken: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Organization>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getOrganizationBySandboxAuthToken(authToken, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['OrganizationsApi.getOrganizationBySandboxAuthToken']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const OrganizationsApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getOrganizationBySandboxAuthToken(authToken: string, options?: RawAxiosRequestConfig): AxiosPromise<Organization> {
      return localVarFp
        .getOrganizationBySandboxAuthToken(authToken, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
...
export class OrganizationsApi extends BaseAPI {
   ...
   * @memberof OrganizationsApi
   */
  public getOrganizationBySandboxAuthToken(authToken: string, options?: RawAxiosRequestConfig) {
    return OrganizationsApiFp(this.configuration)
      .getOrganizationBySandboxAuthToken(authToken, options)
      .then((request) => request(this.axios, this.basePath))
  }
